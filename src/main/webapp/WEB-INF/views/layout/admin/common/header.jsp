				...
				<a class="dropdown-item d-flex align-items-center" href="#">
					<div class="dropdown-list-image mr-3">
						<img class="rounded-circle"
							src="<c:url value="/template/admin/img/undraw_profile_1.svg"/>"
							alt="...">
					...
					<div class="dropdown-list-image mr-3">
						<img class="rounded-circle"
							src="<c:url value="/template/admin/img/undraw_profile_2.svg"/>"
							alt="...">
					...
					<div class="dropdown-list-image mr-3">
						<img class="rounded-circle"
							src="<c:url value="/template/admin/img/undraw_profile_3.svg"/>"
							alt="...">
