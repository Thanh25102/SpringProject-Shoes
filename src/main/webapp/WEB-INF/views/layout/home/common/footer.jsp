...
<!-- jQuery easing -->
<script
	src="<c:url value="/template/home/js/jquery.easing.1.3.min.js"/>"></script>
...
<script type="text/javascript"
	src="<c:url value="/template/home/js/bxslider.min.js"/>"></script>
<script type="text/javascript"
	src="<c:url value="/template/home/js/script.slider.js"/>"></script>