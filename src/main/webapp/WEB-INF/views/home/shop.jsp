				...
				<div class="product-pagination text-center">
					<nav>
						<ul class="pagination">
							...
							<li><a
								href="./shop?idCategory=${empty param.idCategory ? 1 : param.idCategory}&&page=${curPage <= 1 ? 1 : curPage - 1}"
								aria-label="Previous"> <span aria-hidden="true">&laquo;</span>
							</a></li>
							<c:forEach var="index" begin="1" end="${totalPage}">
								<li><a
									href="./shop?idCategory=${empty param.idCategory ? 1 : param.idCategory}&&page=${index}">${index}</a></li>
							</c:forEach>
							<li><a
								href="./shop?idCategory=${empty param.idCategory ? 1 : param.idCategory}&&page=${curPage >= totalPage ? totalPage : curPage + 1}"
