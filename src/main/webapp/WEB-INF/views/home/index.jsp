...
<!-- End slider area -->
<h1>
	<c:if test="${ currentUser !=null }">${ currentUser.toString() }</c:if>
</h1>
		...
		<div class="row">
				...
				<div class="single-product-widget">
					...
					<div class="single-wid-product">
						<a href="single-product.jsp"><img
							src="<c:url value="/template/home/img/product-thumb-1.jpg"/>"
					...
					<div class="single-wid-product">
						<a href="single-product.jsp"><img
							src="<c:url value="/template/home/img/product-thumb-2.jpg"/>"
							alt="" class="product-thumb"></a>
						<h2>
					...
					<div class="single-wid-product">
						<a href="single-product.jsp"><img
							src="<c:url value="/template/home/img/product-thumb-3.jpg"/>"
							alt="" class="product-thumb"></a>
						<h2>
			...
			<div class="col-md-4">
				<div class="single-product-widget">
					...
					<div class="single-wid-product">
						<a href="single-product.jsp"><img
							src="<c:url value="/template/home/img/product-thumb-4.jpg"/>"
							alt="" class="product-thumb"></a>
						<h2>
