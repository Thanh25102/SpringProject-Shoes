									...
									<tr class="cart_item">
										...
										<td class="product-thumbnail"><a
											href="single-product.jsp"><img width="145" height="145"
												...
												src="<c:url value="/template/home/img/product-thumb-2.jpg"/>"></a>
										</td>

										<td class="product-name"><a href="single-product.jsp">Ship
												Your Idea</a></td>
										...
										<td class="actions" colspan="6">
											<div class="coupon">
												<label for="coupon_code">Coupon:</label> <input type="text"
													...
													type="submit" value="Apply" name="apply_coupon"
													class="button">
											</div> <input type="submit" value="UpdateCart" name="update_cart"
											class="button"> <input type="submit" value="Checkout"
							...
							<div class="cross-sells">
								...
								<ul class="products">
									<li class="product"><a href="single-product.jsp"> <img
											...
											src="<c:url value="/template/home/img/product-2.jpg"/>">
									...
									<li class="product"><a href="single-product.jsp"> <img
											width="325" height="325" alt="T_4_front"
											class="attachment-shop_catalog wp-post-image"
											src="<c:url value="/template/home/img/product-4.jpg"/>">
											<h3>Ship Your Idea</h3> <span class="price"><span
												class="amount">£20.00</span></span>
									</a> <a class="add_to_cart_button" data-quantity="1"
										data-product_sku="" data-product_id="22" rel="nofollow"
							...
							<form method="post" action="#" class="shipping_calculator">
								<h2>
									<a class="shipping-calculator-button" data-toggle="collapse"
										...
										aria-controls="calcalute-shipping-wrap">Calculate Shipping</a>
								</h2>
